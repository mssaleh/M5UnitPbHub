...
M5UnitPbHubBinarySensor = m5unit_pbhub_ns.class_("M5UnitPbHubBinarySensor", binary_sensor.BinarySensor, i2c.I2CDevice)

CONFIG_SCHEMA = binary_sensor.BINARY_SENSOR_SCHEMA.extend(
    {
        cv.GenerateID(): cv.declare_id(M5UnitPbHubBinarySensor),
